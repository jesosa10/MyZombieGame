...
function draw() {
  ...
  textSize(20)
  fill("white")
  text("Bullets = " + bullets, displayWidth - 180, displayHeight / 2 - 250)
  text("Score = " + score, displayWidth - 180, displayHeight / 2 - 220)
  text("Lives = " + life, displayWidth - 180, displayHeight / 2 - 280)
  ...
  if (gameState == "lost") {
    ...
    textSize(100)
    fill("red")
    text("You Lost ", width/2 - 300 , height - 150 )
  ...
  //destroy zombie and player and display a message in gameState "won"
    ...
    textSize(100)
    fill("yellow")
    text("You Won ", width/2 - 300 , height - 150)
    zombieGroup.destroyEach();
    player.destroy();
  ...
  //destroy zombie, player and bullets and display a message in gameState "bullet"
    ...
    textSize(50)
    fill("yellow")
    text("You ran out of bullets!!!", width/2 - 200 , height - 150)
    zombieGroup.destroyEach();
    player.destroy();
    bulletGroup.destroyEach();
